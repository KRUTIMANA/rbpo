...
import ru.mtuci.volovodovskiy.exceptions.categories.License.LicenseErrorActivationException;
...
import ru.mtuci.volovodovskiy.model.*;
...
import ru.mtuci.volovodovskiy.service.LicenseService;
...
public class LicenseServiceImpl implements LicenseService {
    ...
    @Override
    public License getActiveLicensesForDevice(Device device, ApplicationUser user, String activationCode) {
        for (DeviceLicense deviceLicense : device.getDeviceLicenses()) {
            ...
            if (license.getUser() != null &&
                ...
                license.getCode().equals(activationCode)) {
                return license;
            }
        }
    ...
    private Long parseRenewalDuration(String duration, License license) {
        try {
            if (duration != null && !duration.isEmpty()) {
                long years = Long.parseLong(duration);
                return years * 12 * 7 * 24 * 60 * 60;
            }
